package com.cicada.library.widget;
...
public class QMUILoadingView extends View {
    ...
    public QMUILoadingView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mSize = array.getDimensionPixelSize(R.styleable.QMUILoadingView_qmui_loading_view_size, DisplayUtils.dp2px(context, 32));
